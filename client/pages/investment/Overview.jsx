...
export default function Overview() {
  ...
  return (
    <div className="company-Overview-page overflow-x-hidden">
      ...
      {/* SECTION 1: Overview */}
      {/* ============================= */}
      <section ref={overviewRef} className="lg:pt-32 3xs:pb-4">

        {/* YOUR FULL SECTION 1 CONTENT */}
        {/** -------------- COPY EXACT CONTENT -------------- */}
      ...
      {/* ============================= */}
      <section ref={diffRef} className="bg-white">
      ...
      <section ref={integratedRef} className="px-[4%] lg:pb-16 sm:pb-12 3xs:pb-4">
        ...
        <ul className="pl-6">
          {[
            ...
            "Co-investment by in IOTC Real Asset ensure the project remains developer driven",
            "Developers interests in the projects",
            "This structure ensures full alignment with investors, transparency and trust.",
          ].map((text, i) => (
            <FadeOnScroll key={i} direction="up" delay={i * 150}>
              <li className="custom-bullet 2xl:text-[300%] lg:text-[120%] text-[#6C6C6C] font-sf-pro mt-6 md:mb-4">
                {text}
              </li>
            </FadeOnScroll>
          ))}
      ...
      {/* ============================= */}
      {/* <section ref={realEstateRef} className="bg-white lg:pb-24 3xs:py-10 3xs:px-5">
