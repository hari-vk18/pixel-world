  ...
  return (
    <div className="bg-white text-gray-900">
      ...
      <section className="w-full  px-0 md:px-0 lg:pt-8 3md:pt-5 lg:pb-16 3xs:pb-10">
        ...
        <FadeOnScroll direction="up" distance={60}>
          <div className="flex lg:mt-[17.3%] 3xs:mt-10 rounded-2xl relative w-full">
            ...
            <img src={aboutBuilding} alt="About building" className="absolute w-[60%] 3xs:h-[140%] xl:h-[142%] lg:h-[154%] 3xs:w-[50%] object-cover inset-0 lg:left-[40%] 3xs:left-[40%] xl:top-[-42%] lg:top-[-54%] 3xs:top-[-40%]"
              style={{
                width: "60%",
              }} />
          </div>
      ...
      <section className="">
        <FadeOnScroll direction="up" distance={40}>
          <div className="mx-[6%]">
            ...
            <p className="text-gray-600 text-lg 2xl:text-[250%] xl:text-[160%] lg:text-left 3xs:text-justify leading-relaxed">
      ...
      <section className="lg:py-20 flex flex-col md:flex-row gap-0 items-stretch mx-[6%] ">
        ...
        <FadeOnScroll direction="right" distance={40} duration={800} delay={150} className="flex-1">
          <div className="2xl:max-w-2xl lg:max-w-lg space-y-10 lg:pl-[4%] 3xs:py-8 flex flex-col justify-center">
            <div className=" px-3">
              ...
              <p className="text-gray-700 2xl:text-[200%] lg:text-[150%] 3xs:text-[110%] font-sf-pro">
        ...
        <section className="relative pt-20 flex w-full overflow-hidden md:pb-16 lg:pb-0 xl:pb-0 2xl:pb-0">
          ...
          <div className="relative z-10 flex flex-col xl:h-full lg:h-[80%] px-4 md:px-16">
            <div className="w-full 3xs:p-4 grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-white font-sf-pro text-2xl md:text-4xl 2xl:text-8xl 2xl:mt-[10%] lg:mt-[5%] 2xs:mt-[2%] font-normal leading-tight md:leading-[53px] tracking-[-1.2px]">
