...
export default function Company() {
  ...
  return (
    <>
      <Helmet>
        <title>Company | IOTC - About Us, Team & Careers</title>
        <meta
          name="description"
          content="Learn about IOTC's leadership team, company values, ESG commitments, and career opportunities. Meet the experts behind our investment platform."
        />
        <meta
          name="keywords"
            ...
            <Route
              ...
              element={
                <>
                  ...
                  <div
                    className="max-w-8xl mx-auto px-4 md:px-16 relative z-10"
                  >
