...
export default function News() {
  return (
    <>
      <Helmet>
        <title>News & Insights | IOTC</title>
        <meta
          name="description"
          content="Stay updated with the latest news, insights, and industry trends from IOTC. Discover our expert analysis on real estate and investment opportunities."
        />
        <meta
          name="keywords"
