...
export default function ProjectsInvestment() {
  ...
  return (
    <>
      <Helmet>
        <title>Projects | IOTC - Investment Opportunities</title>
        <meta
          name="description"
          content="Explore IOTC's project investment portfolio across Europe and Asia Pacific. Discover high-impact real estate and development opportunities."
        />
        <meta
          name="keywords"
