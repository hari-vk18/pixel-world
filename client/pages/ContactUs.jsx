  ...
  return (
    <>
      <Helmet>
        ...
        />
        <meta property="og:title" content="Contact IOTC" />
        <meta property="og:description" content="Get in touch with IOTC's team across Europe, Asia, and the Middle East." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://iotc-ra.com/contact-us" />
        <link rel="canonical" href="https://iotc-ra.com/contact-us" />
      </Helmet>
      <div className="min-h-screen bg-white">
        ...
        <main className="lg:pt-32 3xs:pt-24 pb-16 relative">
          ...
          <div className=" w-full max-w-[2500px] mx-auto mb-16 aspect-[3/1.4] relative">
            <img className="absolute top-0 left-0 w-full h-full object-contain" src="/world.svg" alt="World map showing IOTC office locations"
            />
          ...
          >
            <div className="absolute w-[20%] lg:w-[20%] xl:w-[18%] 2xl:w-[16%] 2xs:w-[60%] md:w-[30%] bottom-0 left-[4%] opacity-5">
              <img src="/IOTC Real Asset logo blue 1 (1).png" alt="IOTC Real Asset company logo" />
            </div>
            <div>
          ...
          <section className="flex lg:flex-row 3xs:flex-col justify-between w-full p-[5%] pb-0">
            ...
            <img src="/fb.png" alt="Facebook social media icon" />
            <img src="/insta (1).png" alt="Instagram social media icon" />
            <img src="/twitter.png" alt="Twitter social media icon" />
          </div> */}
          </section>
