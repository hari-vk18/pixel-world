...
export default function Portfolio() {
    ...
    return (
        <>
            <Helmet>
                <title>Portfolio | IOTC - Investment Projects</title>
                <meta
                    name="description"
                    content="Explore IOTC's diverse portfolio of ongoing and completed investment projects. View our real estate and development projects globally."
                />
                <meta
                    name="keywords"
                    content="portfolio, projects, IOTC, real estate investment, development projects"
                />
                <meta property="og:title" content="IOTC Portfolio - Investment Projects" />
                <meta property="og:description" content="Browse our ongoing and completed real estate investment projects across multiple regions." />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://iotc-ra.com/portfolio" />
                <link rel="canonical" href="https://iotc-ra.com/portfolio" />
            </Helmet>
                        ...
                        <div className="lg:w-[65%] 3xs:w-full md:pl-12 pt-1">
                            <FadeOnScroll direction="up" delay={150} distance={30} duration={800}>
                                <p className="2xl:text-[200%] lg:text-[120%] 3xs:text-[110%] text-[#6C6C6C] font-[400] lg:text-left 3xs:text-justify" style={{ letterSpacing: '-0.04em', lineHeight: '1.4' }}>
                                    From concept to completion, our projects showcase our dedication to delivering real, lasting value. Our projects to see the developments that define our expertise and vision.
                                </p>
                            </FadeOnScroll>
                        </div>
                    </div>
                                            ...
                                            <Link to="/project/agaram" className="relative h-[500px] overflow-hidden group">
                                                ...
                                                <div className="absolute inset-0 p-8 flex flex-col justify-between text-white opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-300">
                                                    ...
                                                    <div className="space-y-3">
                                                        <div className="flex items-center gap-3"><span className="text-base">6 Units</span></div>
                                                        <div className="flex items-center gap-3"><span className="text-base">Solar Panels</span></div>
                                                        <div className="flex items-center gap-3"><span className="text-base">Under Construction</span></div>
                                                    </div>
                                        ...
                                        {(selectedCountry === "all" || selectedCountry === "srilanka") && (
                                            <Link to="/project/aureum" className="relative h-[500px] overflow-hidden group">
                                                ...
                                                <div className="absolute inset-0 p-8 flex flex-col justify-between text-white opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-300">
                                                    ...
                                                    <div className="space-y-3">
                                                        <div className="flex items-center gap-3"><span className="text-base">57 Rooms</span></div>
                                                        <div className="flex items-center gap-3"><span className="text-base">7 Acres</span></div>
                                                        <div className="flex items-center gap-3"><span className="text-base">Under Renovation</span></div>
                                                    </div>
                                                    <div className="flex justify-end"><span className="text-white hover:text-iotc-gold transition-colors duration-300">View Project</span></div>
                                                </div>
                                            </Link>
                                        ...
                                        {(selectedCountry === "all" || selectedCountry === "srilanka") && (
                                            <Link to="/project/aethrina" className="relative h-[500px] overflow-hidden group">
                                                ...
                                                <div className="absolute inset-0 p-8 flex flex-col justify-between text-white opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-300">
                                                    ...
                                                    <div className="space-y-3">
                                                        <div className="flex items-center gap-3"><span className="text-base">40 Units</span></div>
                                                        <div className="flex items-center gap-3"><span className="text-base">10 Floors</span></div>
                                                        <div className="flex items-center gap-3"><span className="text-base">Pre-launch</span></div>
                                                    </div>
                                                    <div className="flex justify-end"><span className="text-white hover:text-iotc-gold transition-colors duration-300">View Project</span></div>
                                                </div>
                                            </Link>
                                        ...
                                        {(selectedCountry === "all" || selectedCountry === "luxembourg") && (
                                            <Link to="/project/mamer" className="relative h-[500px] overflow-hidden group">
                                                ...
                                                <div className="absolute inset-0 p-8 flex flex-col justify-between text-white opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-300">
                                                    ...
                                                    <div className="space-y-3">
                                                        <div className="flex items-center gap-3"><span className="text-base">Premium Quality</span></div>
                                                        <div className="flex items-center gap-3"><span className="text-base">Modern Design</span></div>
                                                        <div className="flex items-center gap-3"><span className="text-base">Planning Phase</span></div>
                                                    </div>
                                                    <div className="flex justify-end"><span className="text-white hover:text-iotc-gold transition-colors duration-300">View Project</span></div>
                                                </div>
                                            </Link>
