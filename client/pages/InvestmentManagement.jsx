...
export default function InvestmentManagement() {
  const investmentLinks = [
    { title: "Overview", href: "#" },
    { title: "Strategic Differentiation", href: "#" },
    { title: "Integrated Investment Structure", href: "#" },
    { title: "Revenue Model & Growth Engine", href: "#" },
    { title: "Real Estate Investment and Asset Management", href: "#" },
  ];
