        ...
        <div className="max-w-8xl mx-auto">
          ...
          <div className="mb-10 3xs:mb-4">
            <div className="max-w-2xl sm:max-w-3xl md:max-w-4xl text-start">
              <h2 className="text-white font-sf-pro text-2xl 3xs:text-xl md:text-4xl lg:text-[38px] 2xl:text-[46px] font-[500] leading-tight sm:leading-[40px] md:leading-[60px] tracking-[-1.12px] mb-6 sm:mb-12"
                style={{
                  cursor: 'default',
          ...
          <div className=" flex flex-wrap lg:flex-row justify-between mt-40 mb-10 3xs:mb-8 3xs:mt-10 relative">
            ...
            <nav className="flex flex-wrap lg:flex-row max-w-[70%] 3xs:flex-col gap-2 sm:gap-4 md:gap-10 justify-center items-center">
            ...
            <div className="flex lg:flex-row 3xs:flex-row items-center space-x-4 sm:space-x-1 top-5 bottom-10 right-[-2rem] 3xs:right-[2rem] 3xs:top-24 md:top-4">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/company/iotc-realasset-nl/" className="text-white hover:text-iotc-gold inline-flex items-center justify-center rounded-sm transition-colors duration-300 w-[44] h-[44] 2xl:w-[56] 2xl:h-[56]">
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/iotc_ra_india?igsh=MTEya25iczUydmFjZw==" className="text-white hover:text-iotc-gold inline-flex items-center justify-center w-11 h-11 rounded-lg transition-colors duration-300" style={{ width: '25px', height: '48px' }}>
