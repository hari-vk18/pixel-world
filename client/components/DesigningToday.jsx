export default function DesigningToday() {
  return (
    <section className="relative h-[805px] w-full overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col h-full px-4 md:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 w-full max-w-7xl mx-auto">
          ...
          <div className="flex flex-col justify-center space-y-8 max-w-8x2">
            <h2 className="text-white font-sf-pro text-4xl md:text-5xl  mt-[30%] lg:text-[350%] font-normal leading-tight md:leading-[93px] tracking-[-1.2px]"
              style={{
                cursor: 'default',
              }}>
          ...
          <div className="flex mt-[16%]">
            <div className="relative">
              <img
                ...
                style={{ width: '528px', height: '501px' }}
              />
              {/* Know more button */}
        ...
        <div className="flex justify-center w-[70%] mt-[10%] ">
          <p className="text-white font-sf-pro text-xl md:text-2xl font-normal italic leading-9 tracking-[-0.5px] w-35%"
            style={{
              cursor: 'default',
            }}
          >
